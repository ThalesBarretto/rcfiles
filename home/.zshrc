...
export MANPAGER='less -s -M +Gg -X --mouse'
source ~/.LESS_TERMCAP
alias ils='kitty +kitten icat --transfer-mode=stream --align=left'
alias sshpc='wol 88:88:88:88:87:88; sleep 2; ssh pc'
PS1=%m%::$PS1
# Disable minikube emojis
#export MINIKUBE_IN_STYLE=false
# Source kubectl completions
source <(kubectl completion zsh)
# Source minikube completions
